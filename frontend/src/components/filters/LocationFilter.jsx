  ...
  return (
    <div>
      ...
      <select
        ...
        className=" w-full max-w-75 h-12 px-4 rounded-xl border dark:text-white border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 outline-none mb-5 "
      >
      ...
      <select
        ...
        className=" w-full max-w-75 h-12 px-4 rounded-xl border dark:text-white border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 outline-none mb-5 disabled:opacity-50 disabled:cursor-not-allowed "
      >
        <option value="">
          {!filters?.countryCode
      ...
      <select
        ...
        className=" w-full max-w-75 h-12 px-4 rounded-xl border dark:text-white border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 mb-5 outline-none disabled:opacity-50 disabled:cursor-not-allowed "
      >
        <option value="">
