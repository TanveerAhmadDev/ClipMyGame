      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="mx-auto max-w-350 px-4 sm:px-6 lg:px-10 pt-4">
          <div className="h-16 rounded-2xl border border-zinc-200/80 bg-white/85 backdrop-blur-xl shadow-sm flex items-center justify-between px-4 sm:px-6">
            ...
            >
              <div className="hidden w-9 h-9 rounded-xl bg-zinc-950 text-white md:flex items-center justify-center font-black text-sm group-hover:rotate-6 transition-transform">
                C
              </div>
      ...
      "
          ...
          "
              >
                YOUR GAME.
                <br />
                <span className="text-green-600">YOUR STORY.</span>
                <br />
                YOUR NEXT
                <br />
        ...
        "
            ...
            overflow-hidden
            bg-zinc-950
            shadow-[10px_12px_0px_#18181b]
            sm:shadow-[20px_25px_0px_#18181b]
          "
              >
                <img
      ...
      <footer className="px-4 sm:px-6 lg:px-10 py-10">
        <div className="max-w-350 mx-auto border-t border-zinc-200 pt-8 flex flex-col sm:flex-row items-center justify-between gap-5">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-zinc-950 text-white flex items-center justify-center font-black text-xs">
              C
            </div>
          ...
          <p className="text-xs text-zinc-500">
            Your game. Your story. Your opportunity.
          </p>
